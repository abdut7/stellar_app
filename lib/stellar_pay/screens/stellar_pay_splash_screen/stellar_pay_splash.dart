...
class _StellarPaySplashScreenState extends State< StellarPaySplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Center(
        child: Image.asset(
          SImages.vectorBackground, fit: BoxFit.cover, color: SColors.color20.withOpacity(0.3),),),),
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Padding(
                padding:  EdgeInsets.only(top: Get.height*0.4), child: Center(child: SvgPicture.asset(SSvgs.stellarSplashLogo,),),),
              const Padding(
                padding:  EdgeInsets.symmetric(vertical: 70),
                child: Text('Stellar Pay, a fast and easy way to\nsend or request money using just the phone\n number', textAlign: TextAlign.center,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  height: 43,
                  decoration: BoxDecoration(color: SColors.color20, borderRadius: BorderRadius.circular(10),),
                  child:  Center(
                    child:
                    Text('Continue', style: TextStyle(fontSize: 17, color: SColors.color19,fontWeight: FontWeight.w400),),),
                ),
              )
            ],
          )],),
