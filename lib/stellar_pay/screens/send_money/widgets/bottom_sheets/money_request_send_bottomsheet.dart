...
void moneysendrequestbottomsheet({required BuildContext context, required String title,required String btnTxt, required Function() ontap}) {
...
Widget toRow({required String label, required String value,required String phone}) {
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceBetween,
    children: [
      Text(
