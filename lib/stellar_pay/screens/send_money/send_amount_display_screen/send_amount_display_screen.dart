...
class SendAmountDisplayScreen extends StatefulWidget {
  ...
  @override
  State<SendAmountDisplayScreen> createState() => _SendAmountDisplayScreenState();
}
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    'Send Money', textAlign: TextAlign.center, style: TextStyle(color: SColors.color20, fontSize: 17, fontWeight: FontWeight.w500,),)),
              ),
            )
