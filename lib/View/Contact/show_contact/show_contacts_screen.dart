      ...
      return Scaffold(
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              Text(
                'Select Contact', style: TextStyle(
                  color:  SColors.color11, fontSize: 18, fontWeight: FontWeight.w700,)),
              const SizedBox(height: 5,),
              Text(
                '675 Contacts',
                style: TextStyle(color: SColors.color11, fontSize: 12, fontWeight: FontWeight.w400,),),
            ],
          ),
          actions: <Widget>[
            PopupMenuButton<int>(
              ...
              itemBuilder: (BuildContext context) => <PopupMenuEntry<int>>[
                ...
                PopupMenuItem<int>(
                  value: 2, child:Text('Contacts', style: TextStyle(color: SColors.color12),),
                ),
                PopupMenuItem<int>(
                  value: 3, child:Text('Refresh', style: TextStyle(color: SColors.color12),),
                ),
                PopupMenuItem<int>(
                  value: 4, child:Text('Help', style: TextStyle(color: SColors.color12),),
                ),
              ],
            ),
          ],
                      ...
                      children: [
                        ...
                        const SizedBox(height: 25,),
                         Padding(
                          ...
                          child: Text(
                            'Contacts On Phone', style: TextStyle(color: SColors.color8,
                              fontSize: 13, fontWeight: FontWeight.w400,
                            ),
                          ),
                        ),
                        const SizedBox(height: 20,),
                        ListContactsWidget(contactsController: contactsController),
                      ],
                    ),
                  ),
      );
