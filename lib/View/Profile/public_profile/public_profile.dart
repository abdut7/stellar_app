              ...
              children: <Widget>[
                Stack(
                  children: <Widget>[
                    ...
                    Positioned(
                      ...
                      GestureDetector(
                          onTap: (){},
                          child: Icon(Icons.more_vert,color: SColors.color12,size: 30,)),
                    ),],),
                ...
                Row(
                  ...
                  child: Container(
                    ...
                    child: const Center(
                      child: Text('Follow', style: TextStyle(fontSize: 14, color: Color.fromRGBO(159, 196, 232, 1)),
                      ),
                    ),
                  ),
                ),
                  ...
                  tabs: [
                    Tab(
                      icon: SvgPicture.asset(
                        SSvgs.flicksLogo, width: 30, height: 30,
                        color: selectedTabIndex == 0 ? null : Colors.grey,
                      ),
                    ),
                    Tab(
                      icon: SvgPicture.asset(
                        SSvgs.channelLogo, width: 30, height: 30,
