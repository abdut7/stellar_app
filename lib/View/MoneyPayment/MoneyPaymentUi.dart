...
import 'package:base_project/widgets/money_custom_row_tile.dart';
import 'package:base_project/widgets/service_agreement_info.dart';
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Container(
                      margin: const EdgeInsets.all(20), width: 21, height: 21,
                      decoration: ShapeDecoration(
                        color: SColors.color14,
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4)),
                      ),
                    ),
                    buildText('USE PAYMENT CODE', 14, SColors.color3, FontWeight.w400,),
                  ],
                ),
                const SizedBox(height: 70,),
                ServiceAgreement(),
                CustomElevatedButton(
                    text: 'ENABLE NOW', textColor: SColors.color3,
                    foregroundColor:  SColors.color4,
                    backgroundColor:  SColors.color14,
                    onPressed: (){}
                ),
                const SizedBox(height: 50,),
                buildText('STELLAR CHAT ENSURES THE SECURITY OF YOUR FUNDS', 8, SColors.color9, FontWeight.w400,),
              ],
            ),),
          const SizedBox(height: 30,),
          CustomRowTile(text: 'RECEIVE MONEY', onPressed: () {},),
          CustomRowTile(text: 'REWARD CODE ', onPressed: () {},),
          CustomRowTile(text: 'SPLIT BILL', onPressed: () {},),
          CustomRowTile(text: 'PACKETS NEARBY', onPressed: () {},),
          CustomRowTile(text: 'TRANSFER TO BANK CARDS', onPressed: () {},),
        ],
      ),
    );
  }
