...
groupChatMainBottomSheet(BuildContext context) {
            ...
            child: Column(
              ...
              children: [
                const Padding(
                  ...
                  child:  Divider(thickness: 3,color: Color.fromRGBO(0, 51, 142, 0.5),),
                ),
                GestureDetector(
                  onTap: () {},
                  child: Text('Group Info', style: TextStyle(color: SColors.color12, fontSize: 11, fontWeight: FontWeight.w600,),),),
                const SizedBox(height: 18,),
                GestureDetector(
                  onTap: () {},
                  child: Text('Search', style: TextStyle(color: SColors.color12, fontSize: 11, fontWeight: FontWeight.w600,),),
                ),
                const SizedBox(height: 18,),
                GestureDetector(
                  onTap: () {
                ...
                GestureDetector(
                  onTap: () {},
                  child: Text(
                    'Exit Group', style: TextStyle(color: SColors.color12, fontSize: 11, fontWeight: FontWeight.w600,),
                  ),
                ),
                const SizedBox(height: 18,),
                GestureDetector(
                  ...
                  child: Text('Clear All Chat', style: TextStyle(color: SColors.color12, fontSize: 11, fontWeight: FontWeight.w600,
                    ),
                  ),
                ),
                const SizedBox(height: 18,),
                GestureDetector(
                  onTap: () {},
                  child: Text(
                    'Export Chat', style: TextStyle(color: SColors.color12, fontSize: 11, fontWeight: FontWeight.w600,),),
                ),
      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              'that you muted this chat', style: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w400,),),
              ...
              children: <Widget>[
                GestureDetector(
                  ...
                  child: Container(width: MediaQuery.of(context).size.width * 0.25,
                    ...
                    child: Center(
                      child: Text(cancelText, style: TextStyle(color: SColors.color12, fontSize: 17, fontWeight: FontWeight.w400,
                      ),
                      ),
                    ),
                  ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    height: 30, decoration: BoxDecoration(color: const Color.fromRGBO(0, 51, 142, 1), borderRadius: BorderRadius.circular(9),),
                    child: Center(
                      child: Text(okText, textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w400,),),
                    ),
                  ),
                ),],),],),);},);
}
